...
public class Empleado extends Persona{
    ...
    public DefaultTableModel leer(){
        ...
        try{
            cn = new Conexion();
            String query = "SELECT e.id_empleado as id,e.codigo,e.nombres,e.apellidos,e.direccion,e.telefono,e.fecha_nacimiento,p.puesto,e.id_puesto FROM empleados as e inner join puestos as p on e.id_puesto = p.id_puesto order by id_empleado;";
            cn.abrir_conexion();
